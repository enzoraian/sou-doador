...
contentsTab.forEach((contentTab) => {
  doadores.forEach((doador) => {
    if (contentTab.id === doador.tipo) {
      ...
      contato.innerHTML = `
            <div class="contato tabs-panel-contato">
                <div class= 'text-doacao'>
                    <p><strong>Nome:</strong> ${doador.nome}</p>
                    <p><strong>Tipo:</strong> ${doador.tipo}</p>
                </div>
                <div>
                    ...
                    <div class="modal">
                        ...
                        <div class="overlay overlay-doacao"></div>

                        <!--Conteúdo-->
                        <div class="box box-doacao">
